...
function Home() {
	...
	return (
		<div>
			...
			<div className='sample-image-container' ref={scrollToEl}>
				sample images
				{samples.map(src => (
					<img
						src={src}
						onClick={() => {
							...
							dispatch({
								...
								payload:
									"https://res.cloudinary.com/dhqp2dd6b/image/upload/v1617456424/image-processing/wh02nmnic8mnxeq2k5bh.png",
							});
