		...
		<div>
			...
			<div className='originalImageSec'>
				...
				<div className='analzeSec'>
					<div
						className={
							cloudImage ? "areaButton activeAnal" : "areaButton nonActiveAnal"
						}
						onClick={cloudImage ? handleAnalyze : ""}>
						Analyze
						{!cloudImage && (
						...
						<div className='row m-0 p-0'>
							<div className='col-12 resultContainer'>
								<span className='resultLabel'>
									Output : Our Forged App analyzed the image and predicted that{" "}
									<b>{result.wht}%</b> of the region is morphed(edited) which is
									shown in white region.
								</span>
							</div>
